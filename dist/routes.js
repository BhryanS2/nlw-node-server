...
router.post("/message", ensureAuthenticated_1.ensureAuthenticated, new CreateMessageController_1.CreateMessageController().handle);
router.get("/message/last3", new GetLast3MessagesController_1.GetLast3MessagesController().handle);
